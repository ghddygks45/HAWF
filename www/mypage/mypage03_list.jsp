...
<head>
    ...
    <title>목록 &gt;  성폭력 피해 신고·상담 내역 &gt; 마이페이지 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="tbl_wrap">
                        ...
                        <div class="tbl_box">
                            <table>
                                <caption>번호, 신청일자, 신고인, 진행현황, 처리일자, 담당자, 상세보기 정보제공</caption>
                                <colgroup>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2020-01-01</td>
                                        <td>김철수</td>
                                        <td><a href="mypage03_view.jsp" class="btn bg_white big">보기</a></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>2020-01-01</td>
