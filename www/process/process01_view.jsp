...
<head>
    ...
    <title>상세 &gt; 교육신청 &gt; 예술인 권익보호 교육 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="btn_wrap">
                        <div class="pos_r">
                            <a href="process01_list.jsp" class="btn bg_bk big pos_l">목록</a>
                            <a href="#n" class="btn bg_red">교육취소</a>
                            <a href="process01_modifi.jsp" class="btn bg_bk big">수정</a>
                        </div>
                    </div>
