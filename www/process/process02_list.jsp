...
<head>
    ...
    <title>목록 &gt; 교육현황 &gt; 예술인 권익보호 교육 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                    ...
                    <div class="tbl_wrap">
                        <div class="tbl_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process02_write.jsp" class="btn bg_bk">교육신청</a>
                                </div>
                            </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>비대면(온라인)</td>
                                        <td><a href="process02_view.jsp">2020년도 권익보호 교육</a></td>
