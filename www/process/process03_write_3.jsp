...
<head>
    ...
    <title>등록 &gt; 설문관리 &gt; 예술인 권익보호 교육 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="tab_wrap">
                        <div class="tab_menu">
                            <ul>
                                <li><a href="process03_write.jsp">공통</a></li>
                                <li><a href="process03_write_2.jsp">강의</a></li>
                                <li class="active"><a href="process03_write_3.jsp">강사</a></li>
                                <li><a href="process03_write_4.jsp">환경</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process03_list.jsp" class="btn bg_bk big">이전</a>
                                    <a href="#n" class="btn bg_bk">임시저장</a>
                                    <a href="process03_list.jsp" class="btn bg_red">설문완료</a>
                                </div>
                            </div>
                        </div>
                        <div class="board_box">
                    ...
                    <div class="btn_wrap">
                        <div class="pos_c">
                            <a href="process03_write_2.jsp" class="btn bg_bk big">이전</a>
                            <a href="process03_write_4.jsp" class="btn bg_red big">다음</a>
                        </div>
                    </div>
