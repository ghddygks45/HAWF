...
<head>
    ...
    <title>목록 &gt; 교육신청 &gt; 예술인 권익보호 교육 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                <div class="location">
                    <ul>
                        ...
                        <li>예술인 권익보호 교육</li>
                        <li class="cur">교육신청</li>
                    </ul>
                </div>  
                <h2 class="title">교육신청</h2>
                <!-- ctn -->
                <div class="ctn">
                    ...
                    <div class="tbl_wrap">
                        <div class="tbl_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process01_write.jsp" class="btn bg_bk">교육신청</a>
                                </div>
                            </div>
                            <a href="#n" class="download_ex">
                                <img src="/HAWF/images/sub/btn_download_excel.jpg" alt="엑셀다운로드">
                            </a>
                        </div>
                        <div class="tbl_box">
                            <table>
                                <caption>교육대상, 교육분류, 학습유형, 교육과정명, 교육기간, 신청인원, 강사, 교육상태 정보제공</caption>
                                <colgroup>
                                ...
                                <thead>
                                    <tr>
                                        <th class="order">교육대상<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">교육분류<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">학습유형<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">교육과정명<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">교육기간<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">신청인원<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">강사<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        <th class="order">교육상태<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>예비예술인</td>
                                        <td class="text_l">성희롱,성폭력 예방교육 &gt; 성희롱,성폭력 예방교육</td>
                                        <td>비대면(온라인)</td>
                                        <td><a href="process01_view.jsp">2020년도 권익보호 교육</a></td>
                                        <td>2020-08-01 14:00 ~ 16:00</td>
                                        <td>50명</td>
                                        <td>윤정수 변호사</td>
                                        <td>신청</td>
                                    </tr>
