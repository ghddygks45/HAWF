...
<head>
    ...
    <title>상세 &lt 대상자관리 &lt 운영관리 &lt 교육관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                ...
                <div class="ctn">
                    <div class="content_wrap">
                            ...
                            <div class="tab_wrap">
                                <div class="tab_menu mt30">
                                    <ul>
                                        ...
                                        <li class="active"><a href="edu0502_view.jsp">대상자관리</a></li>
                                        <li><a href="edu0503_view.jsp">수료관리</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="section">
                            ...
                            <div class="btn_wrap">
                                <div class="pos_l">
                                    <a href="edu0502_list.jsp" class="btn bg_bk big">목록</a>
                                </div>
                            </div>
