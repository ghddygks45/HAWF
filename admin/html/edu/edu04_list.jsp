                            ...
                            <div class="tbl_wrap">
                                <div class="tbl_intro">
                                    ...
                                    <a href="#n" class="download_ex mr28_mt7">
                                        <img src="/HAWF/admin/images/sub/btn_download_excel.jpg" alt="엑셀다운로드">
                                    </a>
                                </div>
                                <div class="tbl_box">
                                    <table>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="order">교육대상<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">교육분류<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">학습유형<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">교육과정명<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">교육기간<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">신청인원<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">강사<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">교육상태<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>강사양성 &lt 심화과정</td>
                                                <td>자체교육과정</td>
                                                <td><a href="edu04_view.jsp">2020년도 권익보호 교육</a></td>
