...
<head>
    ...
    <title>수정 &lt 설문등록관리 &lt 설문관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    <div class="content_wrap">
                        ...
                        <div class="font_col_red mt7">※ 해당문항의 등록된 설문답변이 있는경우 수정 및 삭제가 불가합니다.</div>
                        <div class="btn_wrap">
                            <div class="pos_c">
                                <a href="manage02_list.jsp" class="btn bg_bk big">수정</a>
                                <a href="manage02_list.jsp" class="btn bg_red big">삭제</a>
                            </div>
                        </div>
                    </div>
                </div>
