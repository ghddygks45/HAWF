...
<head>
    ...
    <title>목록 &lt 설문결과 &lt 설문관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                            ...
                            <div class="tbl_wrap">
                                ...
                                <div class="tbl_box">
                                    <table>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="order">해당년도<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                ...
                                                <th class="order">설문명<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">설문일<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th>설문결과</th>
                                            </tr>
                                        </thead>
                                        <tbody>
