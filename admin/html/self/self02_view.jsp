...
<head>
    ...
    <title>상세 &lt 자체교육관리 &lt 자체교육관리 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    <div class="content_wrap">
                        ...
                        <div class="btn_wrap">
                            <div class="pos_r">
                                <a href="self02_list.jsp" class="btn bg_bk big pos_l">목록</a>
                                <a href="self02_modifi.jsp" class="btn bg_bk big">수정</a>
                                <a href="self02_list.jsp" class="btn bg_red">교육과정삭제</a>
                            </div>
                        </div>
