...
<head>
    ...
    <title>상세 &lt 교육승인관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                    ...
                    <div class="content_wrap">
                        ...
                        <div class="board_wrap">
                            ...
                            <div class="board_box">
                                ...
                                <div class="row">
                                    <div class="row_double">
                                        <div class="div_th">수강신청자명</div>
                                        <div class="div_td">홍길동</div>
                                    </div>
                                    <div class="row_double">
                                        <div class="div_th">신청일</div>
                                        <div class="div_td">2020-01-01 12:00</div>
                                    </div>
                                </div>
                        ...
                        <div class="btn_wrap mt20">
                            <div class="pos_r">
                                <a href="approval01_list.jsp" class="btn bg_bk big pos_l">목록</a>
                                <a href="approval01_list.jsp" class="btn bg_bk">선택승인</a>
                                <a href="approval01_list.jsp" class="btn bg_red btn_w90">미승인</a>
                            </div>
                        </div>
