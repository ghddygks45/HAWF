...
<head>
    ...
    <title>목록 &lt 위탁교육관리 &lt 자체교육관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                                    ...
                                    <table>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="order">생년월일<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="self01_view.jsp">HAWF 강사양성 심화과정</a></td>
