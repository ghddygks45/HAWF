...
<head>
    ...
    <title>등록 &lt 질의응답관리 &lt 게시판관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                <div class="sec_top">
                    <div class="tt_box">
                        ...
                        <span class="desc">질의응답을 등록/관리 하실 수 있습니다.</span>
                    </div>
                    <div class="box_intro">
                        <ul>
                ...
                <div class="ctn">
                    <div class="content_wrap">
                        ...
                        <div class="btn_wrap">
                            <div class="pos_c">
                                <a href="notice02_list.jsp" class="btn bg_bk big">등록</a>
                                <a href="notice02_list.jsp" class="btn bg_red big">취소</a>
                            </div>
                        </div>
