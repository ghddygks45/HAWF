...
<head>
    ...
    <title>목록(배정관리) &lt 강사관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                ...
                <div class="ctn">
                    ...
                    <div class="content_wrap">
                        ...
                        <div class="tbl_wrap">
                            ...
                            <div class="tbl_box">
                                <table>
                                    <caption>번호, 교육분류, 학습유형, 교육과정명, 교육기간, 교육상태, 교육시작일, 평가점수, 평가의견/점수 정보제공</caption>
                                    <colgroup>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="order">교육시작일<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                            <th class="order">평가점수<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                            <th>평가의견/점수</th>
                                        </tr>
                                    </thead>
                                    <tbody>
