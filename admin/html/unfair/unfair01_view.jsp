...
<head>
    ...
    <title>관리 &lt 불공정행위 사전상담 &lt 불공정행위 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                ...
                <div class="ctn">
                    <div class="content_wrap">
                        ...
                        <div class="section">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="div_td btn_fun03">
                                            <div class="box_input">
                                                <input type="text">
                                                <div class="btn_wrap">
                                                    <a href="#n" class="btn bg_bk" onclick="popupOpen('find-id3'); return false;">찾아보기</a>
                                                    <a href="#n" class="btn bg_bk plus"><span>추가</span></a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="btn_wrap">
                                <div class="pos_c">
                                    <a href="unfair01_list.jsp" class="btn bg_bk">상담등록</a>
                                    <a href="unfair01_list.jsp" class="btn bg_red big">취소</a>
                                </div>
                            </div>

                            <div class="pop_wrap" data-popup="find-id3">
                                <div class="pop_box w570">
                                    <div class="pop_top">
                                        <div class="tit">대상자 검색</div>
                                    </div>
                                    ...
                                    <div class="pop_close">
                                        <a href="#n" onclick="popupClose('find-id3'); return false;">
                                            <img src="/HAWF/admin/images/layout/btn_popup_close.png" alt="팝업닫기">
                                        </a>
                                    </div>
                                </div>
