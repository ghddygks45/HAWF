...
<head>
    ...
    <title>목록 &lt 불공정행위 사전상담 &lt 불공정행위 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                            ...
                            <div class="tbl_wrap">
                                <div class="tbl_intro">
                                    ...
                                    <div class="btn_wrap pos_r">
                                        <div class="pos_c">
                                            <a href="unfair01_write.jsp" class="btn bg_bk">상담등록</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tbl_box">
                                    <table>
                                        <caption>번호, 신청구분, 신청일자, 신고인, 피신고인, 진행현황, 처리일자, 담당자, 관리</caption>
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>2020-01-01</td>
                                                <td>김철수</td>
                                                <td><a href="unfair01_view.jsp" class="btn bg_white">상세보기</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
