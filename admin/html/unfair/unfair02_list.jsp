...
<head>
    ...
    <title>목록 &lt 불공정행위 신고 &lt 불공정행위 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                            ...
                            <div class="tbl_wrap">
                                <div class="tbl_intro">
                                    ...
                                    <div class="btn_wrap pos_r">
                                        <div class="pos_c">
                                            <a href="unfair02_write.jsp" class="btn bg_bk">상담등록</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tbl_box">
                                    <table>
                                        <caption>번호, 신청구분, 신청일자, 신고인, 구분, 피신고인, 진행현황, 처리일자, 담당자, 관리</caption>
                                        <colgroup>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="order">신청구분<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">신청일자<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">신고인<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">구분<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                <th class="order">피신고인<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                                ...
                                                <th class="order">담당자<img src="/HAWF/admin/images/layout/ico_tbl_th.png" alt="정렬"></th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>2020-01-01</td>
                                                <td>김철수</td>
                                                <td><a href="unfair02_view.jsp" class="btn bg_white">상세보기</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
