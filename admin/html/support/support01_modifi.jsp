...
<head>
    ...
    <title>수정 &lt 상담사관리 &lt 지원관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    <div class="content_wrap">
                        ...
                        <div class="btn_wrap">
                            <div class="pos_c">
                                <a href="support01_list.jsp" class='btn bg_bk big'>수정</a>
                                <a href="support01_list.jsp" class='btn bg_red big'>삭제</a>
                            </div>
                        </div>
