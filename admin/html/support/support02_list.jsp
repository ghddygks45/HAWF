...
<head>
    ...
    <title>목록 &lt 변호사/컨설턴트 관리 &lt 지원관리 | 한국예술인복지재단</title>
    <script>
        $(function(){
             /*  
                            ...
                            <div class="tbl_wrap">
                                <div class="tbl_intro">
                                    ...
                                    <div class="btn_wrap pos_r">
                                        <div class="pos_c">
                                            <a href="support02_write.jsp" class="btn bg_bk">상담사등록</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tbl_box">
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                               <td>1</td>
                                               <td>변호사</td>
                                               <td><a href="support02_modifi.jsp">홍길동</a></td>
                                               <td>제일로펌/변호사협회</td>
                                               <td>불공정행위</td>
                                               <td>02-123-4567</td>
                                               <td>abc@abc.co.kr</td>
                                               <td>활동</td>
                                               <td>
                                                   <a href="support02_modifi.jsp" class="btn bg_white big">관리</a>
                                               </td> 
                                            </tr>
                                        </tbody>
                                    </table>
