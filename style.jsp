            ...
            <article id="content_area">
                ...
                <div class="ctn">
                                ...
                                <table>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="order">교육비<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                            <th class="order">교육기간<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                            <th class="order">학습시간<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                            <th class="order">교육상태<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                            <th class="order">교육기관<img src="/HAWF/images/common/ico_tbl_th.png" alt="정렬"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="applying">
                                            <td>사이버</td>
                                            <td>역량강화를 위한 직무교육<img class="new" src="/HAWF/images/common/ico_new.png" alt="새 목록"></td>
                                            <td>사이버교육</td>
                                            <td>20,000</td>
                    ...
                    <div style="margin-bottom:50px">
                        ...
                        <div class="board_wrap">
                            <div class="board_intro">
                                <h3 class="tt">과정명 : HAWF 강사양성 심화과정</h3>
                                <div class="btn_wrap pos_r">
                                    <div class="c">
                                        <a href="#n" class="btn bg_bk big">수정</a>
                            ...
                            <div class="board_box">
                                <div class="row">
                                    <div class="div_th">교육과정명</div>
                                    <div class="div_td">HAWF 강사양성 심화과정</div>
                                </div>
                                <div class="row">
                                    <div class="div_th">교육기간</div>
