...
<head>
    ...
    <title>불공정행위 신고 &lt 한국예술인복지재단</title>
</head>
<body>
    <div id="wrap">
        <!-- header -->
        ...
        <div class="ctn">
            ...
            <div class="section">
                ...
                <div class="agree_wrap">
                    ...
                    <div class="agree_box mt15">
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>수집·이용하려는 개인정보의 항목 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>개인정보의 수집·이용 목적 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td>예술인복지법 제6조의2 제2항, 제6조의4, 제10조 제1항 제8호, 제16조의2 제2항 및 예술인복지법 시행령 제4조의4 제1호, 제4조의5 제1항 제1호에 의거한 불공정행위로 인한 피해 상담 및 법률적 지원을 위한 상담 서비스</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="agree_wrap">
                    <div class="agree_box">
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>개인정보를 제공받는자 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>제공하는 개인정보의 항목 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>개인정보를 제공받는 자의 개인정보 이용목적 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                        ...
                        <div class="tbl_box type02">
                            <table>
                                <caption>개인정보를 제공받는 자의 개인정보 이용 기간 및 보유기간 정보제공</caption>
                                <colgroup>
                                    <col>
                                </colgroup>
                                <thead>
                        ...
                        <div class="row">
                            ...
                            <div class="div_td form_rd">
                                <div class="box_input">
                                    <div class="check_rd_box">
                                        <span class="rd_lb">
                                            <input type="radio" id="rd15" name="radio4">
                                            <label for="rd15">공개</label>
                                        </span>
                                        <span class="rd_lb">
                                            <input type="radio" id="rd13" name="radio4">
                                            <label for="rd13">비공개</label>
                                        </span>
                                        <span class="rd_lb">
                                            <input type="radio" id="rd14" name="radio4">
                                            <label for="rd14">사건 조치 후 공개</label>
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="btn_wrap m_mt16">
                <div class="pos_c">
                    <a href="#n" class="btn bg_bk">신고등록</a>
